...
<head>
	...
	<body style="background: #f2f2f2;">
		...
		<h1> <p style="color: #e6b800; display: inline;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;
">Lexus Hotel</p></h1>
		...
		<div class="mySlides fade">
		  <img id="1" src="Images/A3.jpg" style="width:100%">
		  <div class="text">ENJOY THE DREAM EXPERIENCE</div>
		</div>

		<div class="mySlides fade">
		  <img id="2" src="Images/A2.jpg" style="width:100%">
		  <div class="text">REDEfINE LUXURY</div>
		</div>

		<div class="mySlides fade">
		  <img id="3" src="Images/A1.jpg" style="width:100%">
		...
		<div id="contact" class="footer">
			...
			<h3 class="foot-text">Developed by Lexus</h3><br>
			<div class="footer-social">
			<a href="#" class=""><i class="fa fa-facebook fa-fw"></i></a>
			<a href="#" class=""><i class="fa fa-instagram fa-fw"></i></a>
			<a href="#" class=""><i class="fa fa-youtube fa-fw"></i></a>
			<a href="#" class=""><i class="fa fa-twitter fa-fw"></i></a>
